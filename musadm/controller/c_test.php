...
Core::factory('Core_Access_Group', 1)->capabilityAllow(Core_Access::USER_EXPORT);
Core::factory('Core_Access_Group', 2)->capabilityAllow(Core_Access::USER_EXPORT);
Core::factory('Core_Access_Group', 3)->capabilityForbidden(Core_Access::USER_EXPORT);
Core::factory('Core_Access_Group', 4)->capabilityForbidden(Core_Access::USER_EXPORT);

Core::factory('Structure', 27)->templateId(6)->save();