...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 28 2018 г., 09:26
...
(5, 1, 'Родительский раздел', 'parentId', 0, 4, 1, 5, 'Structure', ''),
(6, 1, 'Макет', 'template_id', 0, 4, 1, 6, 'Page_Template', ''),
...
--
-- Структура таблицы `Admin_Form_Model`
--

CREATE TABLE `Admin_Form_Model` (
  `id` int(11) NOT NULL,
  `model_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `Admin_Form_Model`
--

INSERT INTO `Admin_Form_Model` (`id`, `model_name`) VALUES
(1, 'Structure'),
(2, 'Structure_Item');
...
INSERT INTO `Constant` (`id`, `title`, `description`, `value`) VALUES
(2, 'INVALID_TYPE', 'Сообщение при передаче недопустимого значения в своства обекта', 'Недопустимый тип передаваемого значения'),
(3, 'TOO_LARGE_VALUE', 'Сообщение при передаче значения, которое превышает допустимую длину', 'Длина значения превышает допустимое значение'),
(4, 'SHOW_LIMIT', 'Лимит показов количества структур и объектов структур', '30');
...
INSERT INTO `Page_Template` (`id`, `title`, `parent_id`) VALUES
(1, 'Главный макет', 0),
(2, 'Вложенный макет', 1),
(3, 'Административный раздел', 0);
...
INSERT INTO `Property` (`id`, `tag_name`, `title`, `description`, `type`, `active`) VALUES
(1, 'price', 'Цена', '', 'int', 1),
(2, 'count', 'Количество', '', 'int', 1),
(3, 'params', 'Параметры', '', 'text', 1),
(4, 'description', 'Описание', '', 'text', 1),
(5, 'list', 'Тестовый список', '', 'list', 1),
(6, 'test', 'Тестовой свойство', '', 'int', 1);
...
(2, 3, 'Какое-то значение дополнительного свойства \"Параметры\"', 'Structure', 1),
(3, 3, 'Значение', 'Structure', 1),
(4, 3, 'Значение', 'Structure', 1);
...
(1, 'Магазин', 0, 'shop', 'catalog', 1, 'Интернет-магазин', 'a:3:{i:0;i:1;i:1;i:5;i:2;i:3;}', 1, 2, '', '', ''),
(2, 'Спорт', 1, 'sport', 'catalog', 1, '', '', 1, 0, '', '', ''),
(3, 'Теннис', 2, 'tennis', 'catalog', 1, '', '', 1, 2, '', '', ''),
(4, 'Футбол', 2, 'football', 'catalog', 1, '', 'b:0;', 1, 1, '', '', ''),
(5, 'Индексная страница', 0, '', 'index', 1, '', 'b:0;', 1, 0, '', '', ''),
(6, 'Административный раздел', 0, 'admin', 'admin/index', 3, '', 'b:0;', 1, 1, '', '', ''),
...
(9, 'Документация', 0, 'documentation', 'documentation/index', 1, 'Руководство по использованию системы', 'b:0;', 1, 0, '', '', '');
...
(1, 'Футбольный мячь', 4, '', 'b:0;', 1, 'SEO title', 'SEO описание', 'SEO ключевые слова', '1', 2),
(2, 'Кросовки Nike', 4, '', 'a:4:{i:0;i:1;i:1;i:5;i:2;i:3;i:3;i:4;}', 1, '', '', '', '2', 1);
...
--
-- Индексы таблицы `Admin_Form_Model`
--
ALTER TABLE `Admin_Form_Model`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `Admin_Form_Model`
--
ALTER TABLE `Admin_Form_Model`
